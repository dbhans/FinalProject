...
<div class="custom-control custom-radio form-group">
  <input type="radio" id="customRadio3" name="flow" class="custom-control-input" value="Finish" <?php if (htmlspecialchars($result[0]['flow'], ENT_QUOTES)=="Finish") echo "checked";?>>
  <label class="custom-control-label" for="customRadio3">Finish</label>
</div>
